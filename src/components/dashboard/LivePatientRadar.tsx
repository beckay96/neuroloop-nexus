  ...
  const mockAlerts: RiskAlert[] = [
    {
      ...
      reason: 'Seizure cluster detected - 3 generalized tonic-clonic seizures in 24 hours. Missed evening medication.',
      status: 'unread',
      historical_trend: [
        { date: '6h ago', score: 45 },
        { date: '4h ago', score: 68 },
        { date: '2h ago', score: 92.5 }
      ],
      context_notes: 'Patient reports increased stress at work. Last blood level: subtherapeutic'
    },
    {
      alert_id: '2',
      patient_id: 'P002',
      ...
      score: 88.0,
      alert_level: 'critical',
      reason: 'Fall with injury reported. Prolonged OFF period and balance issues.',
      status: 'unread',
      historical_trend: [
        { date: '1d ago', score: 55 },
        { date: '12h ago', score: 72 },
        { date: '30m ago', score: 88 }
      ],
      context_notes: 'Medication timing may need adjustment. Consider PT referral.'
    },
    {
      alert_id: '3',
      patient_id: 'P003',
      ...
      risk_type: 'med_failure',
      score: 75.0,
      alert_level: 'moderate',
      reason: 'Missed levodopa doses for 2 consecutive days. Tremor worsening.',
      status: 'acknowledged',
      historical_trend: [
        { date: '3d ago', score: 30 },
        { date: '2d ago', score: 55 },
        { date: '4h ago', score: 75 }
      ],
      context_notes: 'Adherence pattern suggests morning dose confusion'
    },
    {
      alert_id: '4',
      patient_id: 'P004',
      ...
      score: 68.0,
      alert_level: 'moderate',
      reason: 'Breakthrough myoclonic jerks. Sleep deprivation trigger identified.',
      status: 'unread',
      historical_trend: [
        { date: '24h ago', score: 25 },
        { date: '12h ago', score: 48 },
        { date: '6h ago', score: 68 }
      ],
      context_notes: 'Work stress and sleep <5h/night reported'
    },
    {
      alert_id: '5',
      patient_id: 'P005',
      ...
      score: 45.0,
      alert_level: 'low',
      reason: 'Increased emergency department visits pattern detected.',
      status: 'acknowledged',
      context_notes: 'Social support assessment needed'
    }
  ];
