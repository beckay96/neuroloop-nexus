...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      custom_tracking_items: {
        Row: {
          ...
          item_id: string
          item_name: string
          item_type: Database["public"]["Enums"]["custom_tracking_type_enum"]
      ...
      custom_tracking_values: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_tracking_values_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "custom_tracking_items"
    ...
    Functions: {
      ...
      create_research_id_for_user: {
        Args: { p_consent_given?: boolean; p_user_id: string }
        Returns: string
      }
      ...
      get_ai_insights_for_clinician: {
        Args: { p_clinician_id: string }
        Returns: unknown[]
      }
      get_case_panels_for_patient: {
        Args: { p_patient_id: string }
        Returns: unknown[]
      }
      get_clinician_connection_requests: {
        Args: { p_clinician_id: string }
        Returns: {
          accepted_at: string
          cancelled_at: string
      ...
      get_clinician_message_conversations: {
        Args: { p_clinician_id: string }
        Returns: {
      ...
      get_clinician_today_view: {
        Args: { p_clinician_id: string; p_date?: string }
        Returns: {
          alerts: Json
          appointments: Json
          date: string
      ...
      get_conversation_messages: {
        Args: { p_clinician_id: string; p_thread_id: string }
        Returns: {
      ...
      save_basal_temperature_log: {
        Args: {
          p_log_date: string
          p_log_time: string
          p_measurement_location?: string
          p_measurement_type?: string
          p_menstrual_cycle_day?: number
          p_notes?: string
          p_sleep_quality?: string
          p_temperature: number
          p_temperature_unit: string
          p_time_after_waking?: string
          p_user_id: string
        }
        Returns: string
      }
      save_clinician_onboarding: {
        Args: {
          p_clinician_title: string
          p_first_name: string
          p_institution: string
          p_last_name: string
          p_license_number: string
          p_middle_name: string
          p_patient_invite_emails: string[]
          p_specialty: string
          p_user_id: string
        }
        Returns: {
      ...
      save_menstrual_log: {
        Args: {
          p_catamenial_pattern_suspected?: boolean
          p_cycle_end_date?: string
          p_cycle_length_days?: number
          p_cycle_phase?: string
          p_cycle_start_date: string
          p_flow_intensity?: string
          p_is_breastfeeding?: boolean
          p_is_pregnant?: boolean
          p_notes?: string
          p_overall_symptom_severity?: number
          p_seizure_clustered_around_menstruation?: boolean
          p_seizure_count_during_cycle?: number
          p_user_id: string
        }
        Returns: string
      }
